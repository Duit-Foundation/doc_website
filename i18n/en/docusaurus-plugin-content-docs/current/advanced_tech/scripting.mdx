...
In the new version of Duit, script management is handled through a capabilities system. A delegate implementing the [`ScriptingCapabilityDelegate`](/docs/api/dart_api/ScriptingCapabilityDelegate) mixin is responsible for processing and executing dynamic scripts.
