...
4. **Статическое содержимое**: Fragment предназначен для статического содержимого. Для динамических данных используйте [Component](/docs/advanced_tech/components).
...
Для динамических компонентов с данными используйте [Component](/docs/advanced_tech/components/about).